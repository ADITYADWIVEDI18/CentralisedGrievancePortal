            ...
            {isModalOpen && selectedItem && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full">
                        ...
                        <p className="text-gray-700"><strong>Name:</strong> {selectedItem.name || selectedItem.author || "Unknown"}</p>

                        <p className="text-gray-700 mt-2"><strong>Description:</strong> {selectedItem.description || selectedItem.content || "No Description"}</p>
